...
- Shared bulk suite install, uninstall, and package scripts: `scripts/install-suite-local.sh`, `scripts/uninstall-suite-local.sh`, `scripts/package-suite-installer.sh`, `scripts/package-suite-uninstaller.sh`
